...
tags="CCAM_Apple_DETCO"
train_options="10"
test_options="2"
cbam="UP,3"
NewDisentanglers="True"
constraint_terms="True"
Disentangle_spatial="False"
Disentangle_cbam="False"
...
# nohup /bin/bash ./UPLS/start_DETCO.sh >> ./UPLS/cron_DETCO.log 2>&1